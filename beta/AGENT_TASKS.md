...
| SB-04 | Firebase authorization and realtime adapter | A | SB-03 | REVIEW; protected rules, callable and adapter pass local emulators; production release gates pending |
