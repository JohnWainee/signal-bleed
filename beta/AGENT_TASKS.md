...
| SB-09 | Alpha feature parity and migration inventory | Integrator | SB-00 | DONE DOCS; source-backed inventory, migration contract, user decisions and ordered implementation cards in `PARITY.md` |
