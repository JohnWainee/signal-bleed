...
A custom-response generator asks what the character does, what risk they accept, and who or what is involved. It drafts an immediate outcome, one phase-appropriate asset, one real lasting cost—an obligation, exposure, unresolved question, or relationship complication—and private/public receipts from the allowlisted effect vocabulary. A beneficial relationship facet may accompany that cost but cannot replace it. The GM may edit and must approve it before confirmation. A custom response cannot exceed the preset capability budget, erase the event's pressure, alter stats or playbook eligibility, establish cosmic truth, or affect another PC without consent. V1 uses structured templates; generated prose may be layered on later but is not authoritative.
